package com.cobblemon.khataly.mapkit.networking.packet.rocksmash;
...
public record RockSmashPacketC2S(BlockPos pos) implements CustomPayload {
    public static final Identifier ID_RAW = Identifier.of(CobblemonMapKitMod.MOD_ID, "rocksmash_request");
